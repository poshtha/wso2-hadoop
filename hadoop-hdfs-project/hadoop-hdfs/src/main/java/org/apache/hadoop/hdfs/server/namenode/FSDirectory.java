...
public class FSDirectory implements Closeable {
   ...
   */
  DirectoryListing getListing(String srcTenantLess, byte[] startAfter,
      boolean needLocation) throws UnresolvedLinkException, IOException {

      //WSO2: Adding tenant domain.
      String tenantDomain = "deeps";
      String src = "/" + tenantDomain + srcTenantLess;
   ...
   * @throws SnapshotAccessControlException if path is in RO snapshot
   */
  boolean mkdirs(String srcTenantLess, PermissionStatus permissions,
